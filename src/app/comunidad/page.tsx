...
export const metadata: Metadata = {
  title: 'Comunidad',
  description: 'Descubre teorías, pistas y nuevas perspectivas alrededor de los expedientes de El Vago.',
  alternates: { canonical: '/comunidad' },
  openGraph: {
    url: 'https://el-vago.vercel.app/comunidad',
    title: 'Comunidad | El Vago',
    description: 'Descubre teorías, pistas y nuevas perspectivas alrededor de los expedientes de El Vago.',
  },
  twitter: {
    title: 'Comunidad | El Vago',
  ...
  return (
    <main className="wrap">
      ...
      <section className="grid landingGrid">
        <article className="card"><span className="tag">TEORÍAS</span><h2>Comparte tus teorías.</h2><p className="muted">Publica tus hipótesis y explica qué pistas te llevaron hasta ellas.</p><span className="muted">PRÓXIMAMENTE</span></article>
        <article className="card"><span className="tag">PISTAS</span><h2>Debate las evidencias.</h2><p className="muted">Conversa con otros investigadores sobre las pistas de cada expediente.</p><span className="muted">PRÓXIMAMENTE</span></article>
