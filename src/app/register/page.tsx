    ...
    <main className="authPage">
      ...
      <div className="authShell">
        ...
        <section className="authCard">
          <p className="eyebrow">ABRIR EXPEDIENTE PERSONAL</p>
          <h1>Crear cuenta</h1>
          <p className="muted">Crea tu archivo para guardar investigaciones y descubrimientos.</p>
          <form className="stack authForm" onSubmit={go}>
            ...
            <button className="btn" type="submit">Crear mi archivo</button>
